<template>
  <div class="flex w-full flex-col md:col-start-6">
    ...
    <h2 class="mb-3 text-center text-6xl font-bold md:text-right md:text-7xl lg:text-8xl">{{ temp }}°C</h2>
    <div class="mt-4 flex w-full items-center justify-around md:mt-0 md:flex-col md:items-end md:gap-1">
      <h4>
